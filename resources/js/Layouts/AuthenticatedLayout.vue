        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <main>
                <div
                    ...
                    class="p-4 mx-[40px] mt-5 mb-4 text-sm text-green-800 border border-green-300 rounded-lg bg-green-50 dark:text-green-400"
                    role="alert"
                >
                    <div>
                ...
                <div
                    ...
                    class="p-4 mx-[40px] mt-5 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:text-red-400"
                    role="alert"
                >
                    <div>
                        <span class="font-medium">{{
